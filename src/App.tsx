...
export default function App() {
  ...
  useEffect(() => {
    if (!profile) {
      ...
      // Deliberately NOT clearing selectedGroupId: this branch also runs at
      // boot before auth resolves, and wiping it here is what made a reload
      // forget which group was open. refreshGroups validates it anyway.
      return;
    }
